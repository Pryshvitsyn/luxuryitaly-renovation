    ...
    <section className="py-20 bg-slate-50 border-y border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-slate-600">Explore each of our core services in detail. Every page is designed to give you clear, practical information while reflecting the same premium standard you expect from Luxury Italy Renovation
